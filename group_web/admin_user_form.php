            ...
            <form class="d-flex mt-5" action="<?php echo $_SERVER["PHP_SELF"]; 
                ...
                <div class="col-9 ms-5">
                    ...
                    <div class="d-flex mt-5 flex-column align-items-center">
                        <button type="submit" class="btn w-100 col-4 btn-primary">Create</button>
                        <button type="button" class="btn w-100 col-4 btn-danger mt-3" onclick="window.location.href = 'admin_user_list.php'">Cancel</button>
                    </div>
