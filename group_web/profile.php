            ...
            <form class="d-flex mt-5" action="<?php echo $_SERVER["PHP_SELF"]; 
                ...
                <div class="col-9 ms-5">
                    ...
                    <div class="d-flex mt-5 flex-column align-items-center">
                        <button type="submit" class="btn btn-primary w-100 col-4">Update</button>
                        <button type="button" class="btn btn-danger w-100 mt-3 col-4" onclick="window.location.href = 'dashboard.php'">Cancel</button>
                    </div>
